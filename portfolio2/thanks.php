    ...
    <div class="container">
      ...
      <header>
        ...
        <a href="#" class="signin_link">
          <div class="signin_text">Sign In<ion-icon name="chevron-forward-outline"></ion-icon></div>
        </a>
    ...
    <div class="container">
      <footer>
        <div class="footer_top">
          ...
          <div class="footer_top_text">
            <h4>Support</h4>
            <p>Contact<br>Productveiligheid Mededelingen<br>Softwareondersteuning<br>Reparaties<br>Productregistratie<br>Feedback geven</p>
          </div>
          <div class="footer_top_text">
            <h4>Socials</h4>
            <span>
        ...
        <div class="footer_bottom">
          <ul>
            <li><a href="#">©<script>	document.write(new Date().getFullYear())</script> Rowan Lodewijks</a></li>
